        ...
        <div class="col-md-12">
            ...
            <div class="modern-card">
                <div class="d-flex align-items-center mb-4">
                    <div class="icon-circle me-3" style="width: 48px; height: 48px; border-radius: 12px; background: linear-gradient(135deg, #A78BFA 0%, #8B5CF6 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem;">
                        <i class="bi bi-pencil-square"></i>
                    </div>
                    <div>
                        <h4 class="mb-1">编辑代理: <?php echo h($editUser['username']); ?></h4>
                        <p class="text-muted mb-0">修改代理账户信息</p>
                    </div>
                </div>
                ...
                <form method="post" action="<?php echo url('user/edit/' . $editUser['id']); ?>">
                    ...
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-gradient-primary btn-lg">保存修改</button>
                    </div>
                </form>
            </div>
        </div>
